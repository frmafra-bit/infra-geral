...
**DECISÃO 09/07/2026 (Mafra) — NADA vai para `MafraFiori/DAVI_CAMINHOES`.** Não subir nada "por cima do
Ricardo e do Jr": o cliente precisa validar o portal primeiro. O repo deles está **muito defasado** (o
`origin/main` parou em `324c496`, de 25/06, enquanto a nossa branch está ~25 commits à frente) e
**não compensa atualizá-lo**. **FEITO no mesmo dia:** o portal subiu como versão **definitiva 3.0** para o **repositório próprio**
`I16BR/portal-erp` (privado) — ver [[repo-proprio-i16br]]. O `origin` do Ricardo/Junior segue configurado,
intocado e **não recebe push**; só `git fetch` (leitura) é livre. Não empurrar nada para lá sem ordem
explícita do Mafra.
