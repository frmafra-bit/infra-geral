...
- **Davi Caminhões** (base SBO_DAVI_PRD / SBO_HOMOLOG) = razão social **DAVI ALVES DE OLIVEIRA LTDA**, CNPJ **00.700.428/0001-47** (ATIVA), Rod. Índio Tibiriçá 2505, Ouro Fino, Ribeirão Pires/SP, CEP 09411500. **CNAE principal 4930201** (transporte rodoviário de carga). **14 secundários (Receita/BrasilAPI 10/07/2026):** 4930203 (carga perigosa); passageiros: 4923002 (locação c/ motorista), 4924800 (escolar), 4929902 (fretamento), 8622400 (remoção pacientes); locação: 7711000 (auto s/ condutor), 7719599 (outros transportes), 7732201 (máq. construção), 7739099 (outras máq.); construção: 4313400 (terraplenagem), 4213800 (urbanização), 3321000 (instalação máq.); serviços: 7820500 (mão de obra temp.), 8129000 (limpeza). Empresa diversificada: frete + passageiros + locação + obras + serviços.
